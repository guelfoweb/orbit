...
class PersistentMtpLibrary:
    ...
    def _configure_api(self) -> None:
        ...
        lib.orbit_mtp_session_last_validate_steps.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_validate_steps.restype = c_int32
        lib.orbit_mtp_session_last_rows_requested_total.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_rows_requested_total.restype = c_int32
        lib.orbit_mtp_session_last_rows_consumed_estimated_total.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_rows_consumed_estimated_total.restype = c_int32
        lib.orbit_mtp_session_last_rows_wasted_estimated_total.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_rows_wasted_estimated_total.restype = c_int32
        lib.orbit_mtp_session_last_rows_wasted_estimated_ratio.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_rows_wasted_estimated_ratio.restype = ctypes.c_double
        lib.orbit_mtp_session_last_accepted_draft_hist_0.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_accepted_draft_hist_0.restype = c_int32
        lib.orbit_mtp_session_last_accepted_draft_hist_1.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_accepted_draft_hist_1.restype = c_int32
        lib.orbit_mtp_session_last_accepted_draft_hist_2.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_accepted_draft_hist_2.restype = c_int32
        lib.orbit_mtp_session_last_accepted_draft_hist_3.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_accepted_draft_hist_3.restype = c_int32
        lib.orbit_mtp_session_last_accepted_draft_hist_ge4.argtypes = [c_void_p]
        lib.orbit_mtp_session_last_accepted_draft_hist_ge4.restype = c_int32
...
def run_persistent_mtp_completion(
    *,
    ...
    return MtpCompletionResult(
        ...
        validate_steps=int(library.lib.orbit_mtp_session_last_validate_steps(runtime.handle)),
        rows_requested_total=int(library.lib.orbit_mtp_session_last_rows_requested_total(runtime.handle)),
        rows_consumed_estimated_total=int(library.lib.orbit_mtp_session_last_rows_consumed_estimated_total(runtime.handle)),
        rows_wasted_estimated_total=int(library.lib.orbit_mtp_session_last_rows_wasted_estimated_total(runtime.handle)),
        rows_wasted_estimated_ratio=float(library.lib.orbit_mtp_session_last_rows_wasted_estimated_ratio(runtime.handle)),
        accepted_draft_hist_0=int(library.lib.orbit_mtp_session_last_accepted_draft_hist_0(runtime.handle)),
        accepted_draft_hist_1=int(library.lib.orbit_mtp_session_last_accepted_draft_hist_1(runtime.handle)),
        accepted_draft_hist_2=int(library.lib.orbit_mtp_session_last_accepted_draft_hist_2(runtime.handle)),
        accepted_draft_hist_3=int(library.lib.orbit_mtp_session_last_accepted_draft_hist_3(runtime.handle)),
        accepted_draft_hist_ge4=int(library.lib.orbit_mtp_session_last_accepted_draft_hist_ge4(runtime.handle)),
        trace_json=None,
